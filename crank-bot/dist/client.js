...
exports.PDAS = {
    ...
    reserveVault: web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("reserve_vault")], exports.PROGRAM_IDS.staking)[0],
    veriseVault: web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("verise_vault")], exports.PROGRAM_IDS.staking)[0],
